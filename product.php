...
-->
                                ...
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#productModal" id="<?php= $row['id'] ?>" class="btn-details hover" data-hieuung="tooltip" data-placement="top" title="Xem chi tiết"><i class="fas fa-eye"></i>
                                </a>
                            </div>
                        </div>
                        <div class="product-desc ">
